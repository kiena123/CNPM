<footer>
        <div class="footer">
            <div class="col30 footer-logo">
                <img src="{{ asset('assets/image/icon/logo-shop.png') }}" alt="logoshop" />
            </div>
            <div class="col40 freeship">
                <div><img src="{{ asset('assets/image/icon/icon-shipping.png') }}" alt="shipping" /></div>
        ...
        <div class="footer">
            <div class="col20 footer-info">
                ...
                <ul>
                    ...
                    <li>
                        <a target="_blank" href="http://online.gov.vn/"><img src="{{ asset('assets/image/icon/icon-bocongthuong.png') }}" alt="bộ công thương"></a>
                    </li>
                    <li>
                        <a target="_blank" href="https://www.dmca.com/Protection/Status.aspx?ID=1bf3f65e-4ac8-457e-8400-9d299263f727"><img src="{{ asset('assets/image/icon/_dmca_premi_badge_7.png') }}" alt="chứng nhận"></a>
                    </li>
                </ul>
            </div>
